...
class __TwigTemplate_596f1aa1a6f095a5d3ce5c8d13383bac6c3108a9241036cfd6d09201be383fe1 extends Template
{
    private $source;
    private $macros = [];
    ...
    <a href=\"";
        // line 27
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_detalle_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["detalle"]) || array_key_exists("detalle", $context) ? $context["detalle"] : (function () { throw new RuntimeError('Variable "detalle" does not exist.', 27, $this->source); })()), "id", [], "any", false, false, false, 27)]), "html", null, true);
        echo "\">edit</a>
