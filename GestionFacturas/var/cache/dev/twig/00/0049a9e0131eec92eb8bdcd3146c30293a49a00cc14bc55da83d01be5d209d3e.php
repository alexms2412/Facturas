...
class __TwigTemplate_4bc435e69ef09cafcd513cddab0afb88ab11f04d81ecac8ef50e0c19db4cd0ba extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
     ...
     <button class=\"btn\"> ";
        // line 4
        echo twig_escape_filter($this->env, ((array_key_exists("button_label", $context)) ? (_twig_default_filter((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 4, $this->source); })()), "Continuar")) : ("Continuar")), "html", null, true);
        echo "</button>
...
{{ form_end(form) }}
", "pedido/_form.html.twig", "C:\\Users\\aleol\\Desktop\\Pedidos\\GestionFacturas\\templates\\pedido\\_form.html.twig");
    }
}
