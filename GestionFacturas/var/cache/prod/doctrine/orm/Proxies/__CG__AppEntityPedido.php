...
class Pedido extends \App\Entity\Pedido implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Pedido' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Pedido' . "\0" . 'fecha', '' . "\0" . 'App\\Entity\\Pedido' . "\0" . 'estado', '' . "\0" . 'App\\Entity\\Pedido' . "\0" . 'empresa', '' . "\0" . 'App\\Entity\\Pedido' . "\0" . 'detalles', '' . "\0" . 'App\\Entity\\Pedido' . "\0" . 'cliente', '' . "\0" . 'App\\Entity\\Pedido' . "\0" . 'nombrePedido'];
        }
     ...
     * {@inheritDoc}
     */
    public function setEstado(bool $estado): \App\Entity\Pedido
    {
     ...
     * {@inheritDoc}
     */
    public function setEmpresa(?\App\Entity\Empresa $empresa): \App\Entity\Pedido
    {
     ...
     * {@inheritDoc}
     */
    public function addDetalle(\App\Entity\Detalle $detalle): \App\Entity\Pedido
    {
     ...
     * {@inheritDoc}
     */
    public function removeDetalle(\App\Entity\Detalle $detalle): \App\Entity\Pedido
    {
     ...
     * {@inheritDoc}
     */
    public function setCliente(?\App\Entity\Cliente $cliente): \App\Entity\Pedido
    {
    ...
    public function getNombrePedido(): ?string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNombrePedido', []);

        return parent::getNombrePedido();
    }

    /**
     * {@inheritDoc}
     */
    public function setNombrePedido(string $nombrePedido): \App\Entity\Pedido
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNombrePedido', [$nombrePedido]);

        return parent::setNombrePedido($nombrePedido);
    }
