 ...
 */
final class Version20220505213546 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE detalle (id INT AUTO_INCREMENT NOT NULL, pedido_id INT DEFAULT NULL, producto_id INT DEFAULT NULL, cantidad INT NOT NULL, precio INT NOT NULL, INDEX IDX_80397C304854653A (pedido_id), INDEX IDX_80397C307645698E (producto_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pedido (id INT AUTO_INCREMENT NOT NULL, empresa_id INT DEFAULT NULL, cliente_id INT DEFAULT NULL, fecha DATE NOT NULL, estado TINYINT(1) NOT NULL, INDEX IDX_C4EC16CE521E1991 (empresa_id), INDEX IDX_C4EC16CEDE734E51 (cliente_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE producto (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(200) NOT NULL, precio INT NOT NULL, descripcion VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
